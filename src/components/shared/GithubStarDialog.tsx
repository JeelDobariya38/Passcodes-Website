  ...
  return (
    ...
    >
      <div className="dialog-content">
        ...
        <p>
          If Passcodes helps you manage your passwords securely, consider giving
          us a star on GitHub. It helps others discover the project!
          {repoInfo && (
            <>
              {' '}
              ⭐ {formatNumber(repoInfo.stargazers_count)} stars and counting.
            </>
          )}
        </p>
