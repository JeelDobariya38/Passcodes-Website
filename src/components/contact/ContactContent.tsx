...
const contactOptions = [
  ...
  },
  {
    Icon: DiscordIcon,
    title: 'Join Discord',
    description: 'Chat with the community and the maintainers in real time.',
    href: DISCORD_URL,
    label: 'Open Discord',
  },
  {
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          {contactOptions.map((option) => (
            <div key={option.title} className="card flex flex-col text-left">
              ...
              <div className="mt-4">
                <ButtonLink
                  ...
                  rel={option.mail ? undefined : 'noopener noreferrer'}
                  variant="secondary"
                  size="sm"
                >
                  {option.label}
