    ...
    <section className="px-4 py-16 sm:px-6 sm:py-24">
      <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <p className="hero-tagline mt-4">
          Passcodes is a free, open-source password manager for Android. No
          cloud. No accounts. Your data never leaves your phone.
        </p>

        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <ButtonLink href="/downloads" variant="filled">
            <Download className="h-5 w-5" aria-hidden="true" /> Download for
            Android
          </ButtonLink>
          <ButtonLink
